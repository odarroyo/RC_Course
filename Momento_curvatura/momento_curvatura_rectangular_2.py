...
sec = [['section', 'Fiber', sec30x30, '-GJ', 1.0e6],
             ['patch', 'rect', conf, nFibCore, nFibZcore, c-y1col, c-z1col, y1col-c, z1col-c],
             ['patch', 'rect', noconf, nFib, nFibZ, -y1col, -z1col, y1col, c-z1col],
             ['patch', 'rect', noconf, nFib, nFibZ, -y1col, z1col-c, y1col, z1col],
             ['patch', 'rect', noconf, nFibCover, nFibZ, -y1col, c-z1col, c-y1col, z1col-c],
             ['patch', 'rect', noconf, nFibCover, nFibZ, y1col-c, c-z1col, y1col, z1col-c],
